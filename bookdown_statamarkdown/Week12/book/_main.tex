...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{week_10_inf_line.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{week_10_ts_infemp.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{week_10_ts_Dinfemp.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{week_10_ts_D2infemp.png}}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{test}\NormalTok{ pe pe\_1 pe\_2}
\KeywordTok{test}\NormalTok{ pe\_1 pe\_2}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{week_10_augmented_phillips.png}}
\caption{Line graph of inflation}
\end{figure}
