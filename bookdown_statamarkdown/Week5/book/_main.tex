...
\begin{verbatim}
Note: the rank of the differenced variance matrix (5) does not equal the number of coefficients being tested (10);
...
\NormalTok{eststo m3: }\KeywordTok{xtreg}\NormalTok{ lfare concen ldist ldistsq i.y99 i.y00, }\KeywordTok{fe}
\NormalTok{\}}
\NormalTok{esttab m1 m2 m3, mtitle(}\StringTok{"OLS"} \StringTok{"RE"} \StringTok{"FE"}\NormalTok{) }\KeywordTok{drop}\NormalTok{(0.*)}
\end{Highlighting}
\end{Shaded}
