...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{week8_inlflpm.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{week8_inlflogit.png}}
\caption{Marginal Effect of Education}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{week8_inlfprobit.png}}
\caption{Marginal Effect of Education}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{week8_logitinlf.png}}
...
\addcontentsline{toc}{section}{Example Current Population Survey}
...
\addcontentsline{toc}{subsection}{Estimate an Unrestricted model - We'll remove unemployed}
...
\addcontentsline{toc}{subsection}{Estimate a Restricted Model to test Independence of Irrelevant Alternatives assumption}
...
\addcontentsline{toc}{subsection}{Use hausman command}
...
Note: the rank of the differenced variance matrix (2) does not equal the number of
        coefficients being tested (19); be sure this is what you expect, or there may be
...
\addcontentsline{toc}{subsection}{Predicted Probabilities}
...
\addcontentsline{toc}{subsection}{Average Marginal Effects}
...
\addcontentsline{toc}{subsection}{Marginal Effects at the Average}
...
\addcontentsline{toc}{subsection}{Change the Base Alternative}
...
\addcontentsline{toc}{subsection}{Marginal Effects and Marginsplot}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{week8_mnlmeducation.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{week8_mnlmexp.png}}
...
\addcontentsline{toc}{subsection}{We can use coefplot with margins with eststo}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{week8_mnlmcoefplot.png}}
...
variable age not constant within id
    ...
    There are variables other than a, b, id, trial in your data.  They must be constant
    within id because that is the only way they can fit into wide data without loss of
    information.

    The variable or variables listed above are not constant within id.  Perhaps the values
