...
```{stata subset2_5}
quietly cd "/Users/Sam/Desktop/Data/CPS/"
use "smalljul25pub.dta" in 1/10, clear
list 
```
...
```{stata subset4}
sysuse auto, clear
list make price mpg rep78 foreign, sep(5)
```
...
### Import delimited with subset of rows
...
```{stata csv3_1, eval=FALSE}
cd "/Users/Sam/Desktop/Data/NPPES/"
import delimited using npidata_pfile_20050523-20241208.csv, varnames(1) rowrange(1:10) clear
```
