...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Stata Window}]{week1_empty.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Stata toolbar for OSX}]{week1_ribbon.png}}
\caption{Stata toolbar for OSX}
\end{figure}

The most important button is going to be the \textbf{Do-File Editor} button. This is where you do the majority of your work in Stata. The table with the magnifying glass is another important button for a quick click to the \textbf{Browser} window.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Stata Window with Data Loaded}]{week1_sysuse.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Our first histogram}]{week1_histogram.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Formatted Histogram}]{week1_histogram_format.png}}
...
If you need to edit data, I recommend using the \emph{replace} command which we will cover later.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Data Editor in the Toolbar}]{week1_ribbon.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Data Editor}]{week1_editor.png}}
\caption{Data Editor}
\end{figure}
...
\textbf{Efficiency:} Your future time required to do routine tasks drops immensely once your syntax works. Not only can it reduce time for a routine task, you can take snippets of your syntax for other do files. No point in reinventing the wheel! Point and click may be faster up front, but on routine tasks point-and-clicks get left in the dust compared to syntax.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Stata Toolbar on OSX}]{week1_ribbon.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Blank Do File}]{week1_blankdo.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={First Do File}]{week1_firstdo.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Histogram of natural log of wages from our first do file}]{week1_histlwg.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Highlight Do File}]{week1_selectdo.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Highlight Results}]{week1_selectsum.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Paste our Stata results into Word}]{week1_worddoc.png}}
