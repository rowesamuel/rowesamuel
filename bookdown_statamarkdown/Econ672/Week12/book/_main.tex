...
\NormalTok{synth   bmprison  }\CommentTok{///}
...
\begin{Highlighting}[]
\KeywordTok{foreach}\NormalTok{ i }\KeywordTok{of} \KeywordTok{local}\NormalTok{ statelist \{}
  \FunctionTok{matrix} \OtherTok{rownames}\NormalTok{ state}\OtherTok{\textasciigrave{}i\textquotesingle{}}\NormalTok{=}\OtherTok{\textasciigrave{}i\textquotesingle{}}
  \KeywordTok{quietly} \KeywordTok{matlist}\NormalTok{ state}\OtherTok{\textasciigrave{}i\textquotesingle{}}\NormalTok{, names(}\BaseNTok{rows}\NormalTok{) }
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
