...
![DAG 1](./_main_files/figure-html/dag1_1-1.png)
...
![DAG 2](./_main_files/figure-html/dag5_1-1.png)
...
![DAG 3](./_main_files/figure-html/dag2-1.png)

We can use *dagify* command and use labels.
```{r dag2_1, eval=FALSE, echo=TRUE}
...
![DAG 4](./_main_files/figure-html/dag2_1-1.png)
...
![DAG 5](./_main_files/figure-html/dag3_1-1.png)
...
![DAG 6](./_main_files/figure-html/dag4_1-1.png)
...
![DAG 7](./_main_files/figure-html/dag6_1-1.png)
...
![DAG 8](./_main_files/figure-html/dag7_1-1.png)
...
![DAG 9](./_main_files/figure-html/dag8-1.png)
...
![DAG 10](./_main_files/figure-html/dag9-1.png)
...
```{r cycles1,eval=FALSE, echo=TRUE}
...
![DAG 11](./_main_files/figure-html/cycles1-1.png)


**Problematic**! Stuck in a loop.
```{r cycles2,eval=FALSE, echo=TRUE}
...
![DAG 12](./_main_files/figure-html/cycles2-1.png)
...
```{r cycles3,eval=FALSE,echo=TRUE}
...
![DAG 13](./_main_files/figure-html/cycles3-1.png)
