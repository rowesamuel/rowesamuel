...
Iteration 5:  Log likelihood = -404.15991  
...
-------------+----------------------------------------------------------------
     ...
     agecube |   .0005685   .0001113     5.11   0.000     .0003505    .0007866
        educ |   .9247847   .2500694     3.70   0.000     .4346576    1.414912
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Compare Propensity Scores}]{pscore1.png}}
...
ATET         |
       treat |
   (1 vs 0)  |   1725.082   700.0583     2.46   0.014     352.9928    3097.171
------------------------------------------------------------------------------
\end{verbatim}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Density Chart for Age}]{tebalance_age_1.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Box Chart for Age}]{tebalance_box_1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Balance Check After Trimming}]{pscore2.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Density Chart of Age After Trimming}]{tebalance_age_2.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Box Chart of Age After Trimming}]{tebalance_box_2.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Histogram for IPW}]{pscore1.png}}
...
-------------+---------------------------------------------------------
          ht |     16,177   -11876.79    127578.8  -99232.62   1.19e+07
...
-------------+---------------------------------------------------------
          ht |     16,177   -11876.79    127578.8  -99232.62   1.19e+07
         ht2 |     16,177   -11876.79           0  -11876.79  -11876.79
        norm |     16,177    -7238.14    332633.6  -99127.18   3.11e+07
...
\begin{verbatim}
Iteration 0:  EE criterion = 1.354e-21  
Iteration 1:  EE criterion = 7.719e-24  
...
ATET         |
       treat |
   (1 vs 0)  |   2646.866     892.23     2.97   0.003     898.1271    4395.604
-------------+----------------------------------------------------------------
POmean       |
       treat |
          0  |   3791.931   514.4672     7.37   0.000     2783.593    4800.268
------------------------------------------------------------------------------
\end{verbatim}
...
\begin{verbatim}
Iteration 0:  EE criterion = 1.348e-21  
Iteration 1:  EE criterion = 2.117e-30  
...
ATE          |
       treat |
   (1 vs 0)  |   1.610583    .673642     2.39   0.017     .2902694    2.930898
-------------+----------------------------------------------------------------
POmean       |
       treat |
          0  |   4.222608    .376673    11.21   0.000     3.484342    4.960874
------------------------------------------------------------------------------
\end{verbatim}
