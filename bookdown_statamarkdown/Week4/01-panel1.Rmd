...
Let's take a look at a wide-form dataset that needs to be reshaped

![Data in wide form](example_bad_data.png)
...
Our model tells us that 1 percent increase in getting crimes to conviction is associated with a reduction in the current period crime rate of about 0.013 percent. Assuming this model is specified well, crime rates are sensitive to clear-up rates from the prior 2 years.
...
The Pooled OLS shows that an enterprise zone with unemployment insurance claims.
...
When we use a FD estimator, a city that adopts an enterprise is associated with a reduction in unemployment insurance claims by \( (e^(-0.1819)-1)*100\% = 16.6\% \)
